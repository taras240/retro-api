(()=>{var _={date:(a,e)=>{let t=a.DateEarned?new Date(a.DateEarnedHardcore?a.DateEarnedHardcore:a.DateEarned):-1/0;return(e.DateEarned?new Date(e.DateEarnedHardcore?e.DateEarnedHardcore:e.DateEarned):-1/0)-t},earnedCount:(a,e)=>e.NumAwardedHardcore-a.NumAwardedHardcore,points:(a,e)=>parseInt(a.Points)-parseInt(e.Points),truepoints:(a,e)=>a.TrueRatio-e.TrueRatio,default:(a,e)=>a.DisplayOrder===0?_.id(a,e):a.DisplayOrder-e.DisplayOrder,id:(a,e)=>a.ID-e.ID,disable:(a,e)=>0,achievementsCount:(a,e)=>parseInt(a.NumAchievements)-parseInt(e.NumAchievements),title:(a,e)=>{let t=a.Title?.toUpperCase()??a.FixedTitle.toUpperCase(),i=e.Title?.toUpperCase()??e.FixedTitle.toUpperCase();return t<i?-1:t>i?1:0},award:(a,e)=>{let t={event:6,mastered:5,"beaten-hardcore":4,completed:3,"beaten-softcore":2,started:1},i=t[e.award]??0,s=t[a.award]??0,r=new Date(e.AwardedAt),o=new Date(a.AwardedAt);return i-s!=0?i-s:r-o}};var H=class{get _savedCompletionProgress(){return n._cfg?.apiWorker?.completionProgress??{}}get SAVED_COMPLETION_PROGRESS(){let e=this._savedCompletionProgress;return!e?.Total||n._cfg.apiWorker.targetUser!==n.targetUser?this.updateCompletionProgress({batchSize:500}).then(()=>this._savedCompletionProgress):this.updateCompletionProgress({batchSize:20,savedArray:e.Results}).then(()=>this._savedCompletionProgress)}set SAVED_COMPLETION_PROGRESS(e){e.Results=e.Results.map(t=>(delete t.ConsoleName,delete t.NumLeaderboards,t)),n._cfg.apiWorker||(n._cfg.apiWorker={}),n._cfg.apiWorker.targetUser=n.targetUser,n._cfg.apiWorker.completionProgress=e,n.writeConfiguration()}baseUrl="https://retroachievements.org/API/";endpoints={userProfile:"API_GetUserProfile.php",gameProgress:"API_GetGameInfoAndUserProgress.php",recentAchieves:"API_GetUserRecentAchievements.php",gameInfo:"API_GetGame.php",extendedGameInfo:"API_GetGameExtended.php",recentlyPlayedGames:"API_GetUserRecentlyPlayedGames.php",userAwards:"API_GetUserAwards.php",userGameRankAndScore:"API_GetUserGameRankAndScore.php",completionProgress:"API_GetUserCompletionProgress.php",gameList:"API_GetGameList.php",userSummary:"API_GetUserSummary.php",wantToPlay:"API_GetUserWantToPlayList.php"};async getLastUnlocks({apiKey:e,targetUser:t,minutes:i}){let s=new URL(this.endpoints.recentAchieves,this.baseUrl),r={y:e||n.API_KEY,u:t||n.targetUser,m:i||1440*7};return s.search=new URLSearchParams(r),(await fetch(s).then(l=>l.json()))?.map(l=>({...l,ID:l.AchievementID,DateEarned:l.Date})).sort((l,m)=>_.date(l,m))??[];return[{ID:383065,GameID:1891,GameTitle:"Puzznic",Title:"Enigma Explorer",Description:"Reach a score of 50,000 in Puzznic",Points:2,Type:null,BadgeName:"432937",IsAwarded:"1",DateAwarded:"2026-06-05 17:13:14",HardcoreAchieved:1},{ID:383073,GameID:1891,GameTitle:"Puzznic",Title:"Puzznic Level 1 - Riddle Ridge",Description:"In a single session, complete all of the Puzznic puzzles on level 1 [No continues]",Points:3,Type:"progression",BadgeName:"432901",IsAwarded:"1",DateAwarded:"2026-06-05 17:11:57",HardcoreAchieved:1}]}getUrl({endpoint:e,targetUser:t,gameID:i,minutes:s,apiKey:r,userName:o,achievesCount:c,count:l,offset:m}){let u=new URL(e,this.baseUrl),g={y:r||n.API_KEY,z:o||n.USER_NAME,u:t||n.targetUser,g:i||n.gameID,m:s||2e3,i:i||n.gameID,f:1,h:1,a:c||5,c:l||20,o:m||0};return u.search=new URLSearchParams(g),u}constructor(){}getUserCompelitionProgress({targetUser:e,count:t,offset:i}){let s=this.getUrl({targetUser:e||n.targetUser,count:t||100,offset:i||0,endpoint:this.endpoints.completionProgress});return fetch(s).then(r=>r.json()).then(r=>(r.Results=r.Results.map(o=>(o.ID=o.GameID,o.NumAchievements=o.MaxPossible,delete o.MaxPossible,delete o.NumLeaderboards,o)),r))}getUserAwards({targetUser:e}){let t=this.getUrl({targetUser:e||n.targetUser,endpoint:this.endpoints.userAwards});return fetch(t).then(i=>i.json()).then(i=>(i.VisibleUserAwards=i.VisibleUserAwards.map(s=>["Mastery/Completion","Game Beaten"].includes(s.AwardType)?(s.award=s.AwardType=="Game Beaten"?s.AwardDataExtra=="1"?"beaten":"beaten_softcore":s.AwardDataExtra=="1"?"mastered":"completed",s.DateEarned=s.AwardedAt,s.ConsoleName=="Events"&&(s.award="event"),s.timeString=this.toLocalTimeString(s.AwardedAt),s=this.fixGameTitle(s),s):null).filter(s=>s),i))}getGameProgress({targetUser:e,gameID:t}){let i=this.getUrl({endpoint:this.endpoints.gameProgress,targetUser:e||n.targetUser,gameID:t||n.gameID});return fetch(i).then(s=>s.json()).then(s=>{s={...s,TotalRealPlayers:0,TotalRetropoints:0,points_total:0,progressionRetroRatio:0,beatenCount:1/0,masteredCount:1/0,earnedStats:{soft:{count:0,points:0,retropoints:0},hard:{count:0,points:0,retropoints:0}}};let r={Count:0,WinCount:0,WinAwardedCount:0,WinEarnedCount:0},o={isBeaten:!0,isBeatenSoftcore:!0,isWinEarned:!1,isWinEarnedSoftcore:!1};for(let l of Object.values(s.Achievements))s.TotalRetropoints+=l.TrueRatio,s.points_total+=l.Points,s.TotalRealPlayers<l.NumAwarded&&(s.TotalRealPlayers=l.NumAwarded),l.DateEarned&&(s.earnedStats.soft.count+=1,s.earnedStats.soft.points+=l.Points,s.earnedStats.soft.retropoints+=l.TrueRatio),l.DateEarnedHardcore&&(s.earnedStats.hard.count+=1,s.earnedStats.hard.points+=l.Points,s.earnedStats.hard.retropoints+=l.TrueRatio),l.type==="progression"&&(r.Count++,l.DateEarned?l.DateEarnedHardcore||(o.isBeaten=!1):(o.isBeaten=!1,o.isBeatenSoftcore=!1),s.beatenCount>l.NumAwardedHardcore&&(s.beatenCount=l.NumAwardedHardcore)),l.type==="win_condition"&&(l.DateEarnedHardcore?(o.isWinEarned=!0,o.isWinEarnedSoftcore=!0):l.DateEarned&&(o.isWinEarnedSoftcore=!0),r.WinCount++,l.NumAwardedHardcore>r.WinAwardedCount&&(r.WinAwardedCount=l.NumAwardedHardcore),l.DateEarnedHardcore&&r.WinEarnedCount++),l.NumAwardedHardcore<s.masteredCount&&(s.masteredCount=l.NumAwardedHardcore);s.achievements_published==s.NumAwardedToUserHardcore?s.award="mastered":o.isBeaten&&(o.isWinEarned||r.WinCount==0)&&(s.award="beaten"),s={...s,winVariantCount:r.WinCount,winEarnedCount:r.WinEarnedCount,progressionSteps:r.WinCount>0?r.Count+1:r.Count},r.WinCount>0&&(s.beatenCount=r.WinAwardedCount),s.beatenCount!=1/0&&(s.beatenRate=~~(1e4*s.beatenCount/s.TotalRealPlayers)/100),s.masteredCount!=1/0&&(s.masteryRate=~~(1e4*s.masteredCount/s.TotalRealPlayers)/100);let c=~~(s.TotalRetropoints/s.points_total*100)/100;return s.retroRatio=c,s.gameDifficulty=c>9?"insane":c>7?"expert":c>5?"pro":c>3?"standard":"easy",Object.values(s.Achievements).map(l=>this.fixAchievement(l,s)),s=this.fixGameTitle(s),s})}getGameInfo({gameID:e,extended:t}){let i=this.getUrl({endpoint:this.endpoints[t?"extendedGameInfo":"gameInfo"],gameID:e});return fetch(i).then(s=>s.json())}getUserProfile({userName:e}){let t=this.getUrl({targetUser:e,userName:e,endpoint:this.endpoints.userProfile});return fetch(t).then(i=>i.json())}getUserSummary({targetUser:e,gamesCount:t=3,achievesCount:i}){let s=this.getUrl({targetUser:e,gameID:t,achievesCount:i,endpoint:this.endpoints.userSummary});return fetch(s).then(r=>r.json()).then(r=>(r.RecentlyPlayed=r.RecentlyPlayed.map(o=>(o.LastPlayed=this.toLocalTimeString(o.LastPlayed),r.Awarded[o.GameID]&&(o={...o,...r.Awarded[o.GameID]}),o=this.fixGameTitle(o),o)),r.RecentAchievements=Object.values(r.RecentAchievements).flatMap(o=>Object.values(o)).map(o=>(o.DateEarned=this.toLocalTimeString(o.DateAwarded),o)),r.isInGame=new Date-new Date(r.RecentlyPlayed[0].LastPlayed)<300*1e3,r))}verifyUserIdent({userName:e,apiKey:t}){let i=this.getUrl({targetUser:e,userName:e,apiKey:t,endpoint:this.endpoints.userProfile});return fetch(i).then(s=>s.json())}getGameList({userName:e,apiKey:t,systemID:i}){let s=this.getUrl({userName:e,apiKey:t,gameID:i,endpoint:this.endpoints.gameList});return fetch(s).then(r=>r.json())}doTestEndpoint({endpoint:e}){let t=this.getUrl({endpoint:e});return fetch(t).then(i=>i.json()).then(i=>console.log(i))}async updateCompletionProgress({savedArray:e=[],completionProgress:t=[],batchSize:i=500}){let s=await this.getUserCompelitionProgress({count:i,offset:t.length});t=[...t,...s.Results];let r=t.at(-1);if(e.findIndex(c=>c.hasOwnProperty("GameID")&&c.GameID===r.GameID&&c.MostRecentAwardedDate===r.MostRecentAwardedDate)>=0||t.length===s.Total){let c=t.map(l=>l.GameID);e=e.filter(l=>!c.includes(l.GameID)),e=[...t,...e],this.SAVED_COMPLETION_PROGRESS={Total:e.length,Results:e}}else setTimeout(()=>this.updateCompletionProgress({savedArray:e,completionProgress:t,batchSize:i}),100)}fixAchievement(e,t){let{BadgeName:i,DateEarned:s,DateEarnedHardcore:r,NumAwardedHardcore:o,NumAwarded:c,TrueRatio:l,ID:m}=e,{NumDistinctPlayers:u,NumAwardedToUserHardcore:g,TotalRealPlayers:T}=t,f=100*(o-g*.5)/((u+T)*.5-g*.5);t.Achievements[m]={...e,totalPlayers:u,isEarned:!!s,isHardcoreEarned:!!r,DateEarned:s&&this.toLocalTimeString(s),DateEarnedHardcore:r&&this.toLocalTimeString(r),prevSrc:`https://media.retroachievements.org/Badge/${i}.png`,rateEarned:~~(100*c/u)+"%",rateEarnedHardcore:~~(100*o/u)+"%",trend:f,difficulty:f<1.5&&l>300||l>=500?"hell":f<=3&&l>100||l>=300?"insane":f<8&&l>24?"expert":f<13&&l>10?"pro":f<20&&l>5||l>10?"standard":"easy"}}fixGameTitle(e){let t=[/\[SUBSET[^\[]*\]/gi,/~[^~]*~/g,".HACK//"],i=e.Title,s=t.reduce((r,o)=>{let c=new RegExp(o,"gi"),l=e.Title?.match(c);return l&&l.forEach(m=>{i=i.replace(m,"");let u=m;r.push(u.replace(/[~\.\[\]]|subset -|\/\//gi,""))}),r},[]);return e.badges=s,e.FixedTitle=i?.trim(),e}toLocalTimeString(e){!/(\+00\:00$)|(z$)/gi.test(e)&&(e+="+00:00");let i=new Date(e),s={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!1};return i}async getWantToPlayGamesList({apiKey:e,targetUser:t,count:i,offset:s}){let r=new URL(this.endpoints.wantToPlay,this.baseUrl),o={y:e||n.API_KEY,u:t||n.targetUser,o:s||0};return r.search=new URLSearchParams(o),(await fetch(r).then(l=>l.json())).Results||[]}};var J="retroApiConfig",N=class{get version(){return this._cfg.version??"0"}set version(e){this._cfg.version=e,this.writeConfiguration()}get API_KEY(){return this._cfg.identification.RAApi_key}set API_KEY(e){this._cfg.identification.RAApi_key=e,this.writeConfiguration()}get USER_NAME(){return this._cfg.identification.RAApi_login}set USER_NAME(e){this._cfg.identification.RAApi_login=e,this.writeConfiguration()}get identConfirmed(){return this._cfg.identification.identConfirmed??!1}set identConfirmed(e){this._cfg.identification.identConfirmed=e,this.writeConfiguration()}get userImageSrc(){return this._cfg.identification.userImageSrc||""}set userImageSrc(e){this._cfg.identification.userImageSrc=e,this.ui.buttons&&(ui.buttons.userImage.src=e),this.writeConfiguration()}get targetUser(){return this._cfg.settings.targetUser||this.USER_NAME}set targetUser(e){this._cfg.settings.targetUser=e,this.writeConfiguration(),this.identConfirmed&&(ui.settings.getLastGameID(),ui.awards.updateAwards())}get gameID(){return this._cfg.settings.gameID}set gameID(e){this._cfg.settings.gameID=e,this.writeConfiguration()}get ui(){return this._cfg.ui}constructor(){this.readConfiguration()}readConfiguration(){let e=JSON.parse(localStorage.getItem(J));e||(e={identification:{RAApi_key:"",RAApi_login:""},settings:{updateDelay:15,sort:"default",gameID:1},ui:{}}),this._cfg=e,localStorage.setItem(J,JSON.stringify(this._cfg)),this.writeConfiguration()}delayedWrite;writeConfiguration(){clearTimeout(this.delayedWrite),this.delayedWrite=setTimeout(()=>{localStorage.setItem(J,JSON.stringify(this._cfg))},1e3)}};function S(a){return a?.reduce((e,t)=>e+=`<i class="game-badge game-badge__${t.toLowerCase()}">${t}</i>`,"")}function R(a){return a?new Date(a).toLocaleString():null}var p=a=>{/\/>/g.test(a)&&(a=a.replace(/<(\w+)([^>]*)\/>/g,(t,i,s)=>new Set(["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"]).has(i.toLowerCase())?t:`<${i}${s}></${i}>`));let e=document.createElement("template");return e.innerHTML=a.trim(),e.content.firstElementChild};function ie(a){let e=+(a.retropoints/a.hardpoints).toFixed(2);return`
    ...
    `}var F=({BadgeName:a})=>`https://media.retroachievements.org/Badge/${a}.png`,E=a=>`https://media.retroachievements.org${a}`;function Y(a,e){let{Title:t,Description:i,ID:s,GameID:r,HardcoreAchieved:o,HardcoreMode:c,IsAwarded:l,DateEarned:m,BadgeName:u,Points:g,DateEarnedHardcore:T}=a;e??={ID:r};let y=p(`
                    <div class="list-item achievement ${o||m?"unlocked":"locked"} ${T||c?"hardcore":""}">
                        <div class="item-icon">
                            <img class="item-img" src="${F({BadgeName:u})}"/>
                        </div>
                        <div class="item-meta">
                            <div class="item-name">${t}</div>
                            <div class="item-desc">${i}</div>
                            
                            <div class="game-stats__text cheevo-stats__unlocked">${ye(m)}</div>
                        </div>
                        <div class="item-points">${g}</div>
                    </div>
                `);return y.addEventListener("click",G=>{G.stopPropagation(),d.showAchivDetails(a.ID,e?.ID),console.log(a)}),y}function se({lastAchievements:a}){return a.map(e=>Y(e))}var ye=a=>{let e=new Date(a);return e.toLocaleString()};function we(a){let{GameID:e,ImageIcon:t,FixedTitle:i,badges:s,LastPlayed:r,ConsoleName:o,NumAchieved:c,NumAchievedHardcore:l,NumPossibleAchievements:m,ScoreAchieved:u,ScoreAchievedHardcore:g,PossibleScore:T}=a,f=p(`    
    ...
    `);return f.addEventListener("click",y=>{y.stopPropagation(),d.showGameDetails(e)}),f.querySelector(".user-info__game-preview-container")?.addEventListener("click",y=>{y.stopPropagation(),d.goto.game(e)}),f.querySelector(".game-stats__button")?.addEventListener("click",y=>{y.stopPropagation(),d.expandGameItem(e,y.target)}),f}function re({lastGames:a}){return a.map(e=>we(e))}var X=a=>new Promise(e=>setTimeout(e,a));var be=(...a)=>[...new Set(a.filter(e=>e))].join(" | ");function oe(a,e){let t=(c,...l)=>{let m=be(...l);return m?`
            ...
            `:""},i=new Date().toLocaleDateString(),s=e.filter(c=>new Date(c.Date).toLocaleDateString()==i),r=s.length,o=s.reduce((c,l)=>(l.HardcoreMode===1?(c.hardcorePoints+=l.Points,c.retroPoints+=l.TrueRatio,c.countHardcore++):(c.countCasual++,c.casualPoints+=l.Points),c),{countHardcore:0,hardcorePoints:0,retroPoints:0,countCasual:0,casualPoints:0});return r?`
            <div class="daily__container">
                <h2 class="daily__header">Daily progress</h2>
                <ul class="daily__progress-list">
                    ${t("Unlocks",o.countHardcore,o.countCasual)}
                    ${t("Points",o.hardcorePoints,o.casualPoints)}
                    ${t("Retropoints",o.retroPoints)}
                </ul>
            </div>
        `:""}var $,ne,L=class{constructor(){this.update()}async update(){if(d.showLoader(),$){let e=this.HomeSection();d.content.innerHTML="",d.content.append(e),d.removeLoader()}else await this.loadUserInfo(),this.update()}async loadUserInfo(){let e=await h.getUserSummary({gamesCount:8,achievesCount:8});await X(50),ne=await h.getLastUnlocks({minutes:1440}),$={userName:e.User,status:e.Status?.toLowerCase(),richPresence:e.RichPresenceMsg,memberSince:e.MemberSince,userImageSrc:`https://media.retroachievements.org${e.UserPic}`,userRank:e.Rank?`Rank: ${e.Rank} (Top ${~~(1e4*e.Rank/e.TotalRanked)/100}%)`:"Rank is unavailable",softpoints:e.TotalSoftcorePoints,retropoints:e.TotalTruePoints,hardpoints:e.TotalPoints,lastGames:e.RecentlyPlayed,lastAchievements:Object.values(e.RecentAchievements).map(t=>(t.HardcoreAchieved?t.DateEarnedHardcore=t.DateAwarded:t.DateEarned=t.DateAwarded,t)).sort((t,i)=>_.date(t,i)),isInGame:e.isInGame}}HomeSection(){let e=p(`
        ...
        `);return e.querySelector(".recent-cheevos-list").append(...se($)),e.querySelector(".recent-games-list").append(...re($)),e.querySelector("#see-more-cheevos")?.addEventListener("click",s=>{d.goto.unlocks()}),e}};var C=a=>new Promise(e=>setTimeout(e,a));function D({list:a,items:e,callback:t}){let i=document.createElement("div");i.classList.add("lazy-load_trigger"),a.appendChild(i);let s=0,r=40,o=u=>{for(let g=0;g<u&&s<e.length;g++)a.appendChild(t(e[s++]))};o(r);let c=(u,g)=>{u.forEach(T=>{T.isIntersecting&&(o(r),g.unobserve(i),s<e.length?(a.appendChild(i),g.observe(i)):i.remove())})},l={root:null,rootMargin:"0px",threshold:1};new IntersectionObserver(c,l).observe(i)}var w={1:"Genesis/Mega Drive",2:"Nintendo 64",3:"SNES/Super Famicom",4:"Game Boy",5:"Game Boy Advance",6:"Game Boy Color",7:"NES/Famicom",8:"PC Engine/TurboGrafx-16",9:"Sega CD",10:"32X",11:"Master System",12:"PlayStation",13:"Atari Lynx",14:"Neo Geo Pocket",15:"Game Gear",17:"Atari Jaguar",18:"Nintendo DS",19:"Nintendo Wii",21:"PlayStation 2",23:"Magnavox Odyssey 2",24:"Pokemon Mini",25:"Atari 2600",27:"Arcade",28:"Virtual Boy",29:"MSX",33:"SG-1000",37:"Amstrad CPC",38:"Apple II",39:"Saturn",40:"Dreamcast",41:"PlayStation Portable",43:"3DO Interactive Multiplayer",44:"ColecoVision",45:"Intellivision",46:"Vectrex",47:"PC-8000/8800",49:"PC-FX",51:"Atari 7800",53:"WonderSwan",56:"Neo Geo CD",57:"Fairchild Channel F",63:"Watara Supervision",69:"Mega Duck",71:"Arduboy",72:"WASM-4",73:"Arcadia 2001",74:"Interton VC 4000",75:"Elektor TV Games Computer",76:"PC Engine CD/TurboGrafx-CD",77:"Atari Jaguar CD",78:"Nintendo DSi",80:"Uzebox",101:"Events",102:"Standalone"};var I,B=class{awardTypeContext=()=>({label:"Filter by type",elements:[{label:`All (${I.VisibleUserAwards.length})`,id:"filter_all",type:"radio",onChange:"ui.awards.awardFilter = 'award'",checked:this.awardFilterName==="award",name:"filter-by-award"},...Object.getOwnPropertyNames(this.awardTypes).reduce((e,t)=>{let i={label:`${this.awardTypes[t].name} (${this.awardTypes[t].count})`,id:`filter_code-${t}`,type:"radio",onChange:`ui.awards.awardFilter = '${t}'`,checked:this.awardFilterName==t,name:"filter-by-award"};return e.push(i),e},[])]});awardPlatformContext=()=>({label:"Filter by platform",elements:[{label:`All (${I.VisibleUserAwards.length})`,id:"filter_all",type:"radio",onChange:"ui.awards.platformFilterCode = 'platform'",checked:this.platformFilterName==="platform",name:"filter-by-platform"},...Object.getOwnPropertyNames(this.platformCodes).reduce((e,t)=>{let i={label:`${this.platformCodes[t].name} (${this.platformCodes[t].count})`,id:`filter_code-${t}`,type:"radio",onChange:`ui.awards.platformFilterCode = ${t}`,checked:this.platformFilterCode==t,name:"filter-by-platform"};return e.push(i),e},[])]});awardSortContext=()=>({label:"Sort by",elements:[{label:"Date earned",id:"sort_date-earned",type:"radio",onChange:"ui.awards.awardSortType = 'date'",checked:this.awardSortType==="date",name:"sort-awards"},{label:"Type",id:"sort_award-type",type:"radio",onChange:"ui.awards.awardSortType = 'award'",checked:this.awardSortType==="award",name:"sort-awards"},{label:"Title",id:"sort_title",type:"radio",onChange:"ui.awards.awardSortType = 'title'",checked:this.awardSortType==="title",name:"sort-awards"},{label:"Reverse sort",id:"sort_reverse-sort",type:"checkbox",onChange:"ui.awards.awardSortTypeReverse = this.checked",checked:this.awardSortTypeReverse==-1,name:"sort-awards-reverse"}]});awardListContext=()=>({label:"Show by",elements:[...Object.getOwnPropertyNames(this.listTypes).reduce((e,t)=>{let i={label:`${this.listTypes[t]}`,id:`awards_list-type-${t}`,type:"radio",onChange:`ui.awards.listType = '${t}'`,checked:this.listType==t,name:"awards-list-type"};return e.push(i),e},[])]});get listType(){return n.ui?.mobile?.listType??"list"}set listType(e){n.ui.mobile.listType=e,n.writeConfiguration(),this.update()}get awardFilter(){let e=n.ui?.mobile?.awardsTypeFilter??"award";return this.awardTypesNames[e]}get awardFilterName(){return n.ui?.mobile?.awardsTypeFilter??"award"}set awardFilter(e){n.ui.mobile.awardsTypeFilter=e,n.writeConfiguration(),this.update()}get platformFilterName(){let e=n.ui?.mobile?.platformFilter??"platform";return e=="platform"?"platform":w[e]}get platformFilterCode(){return n.ui?.mobile?.platformFilter??"platform"}set platformFilterCode(e){n.ui.mobile.platformFilter=e,n.writeConfiguration(),this.update()}get awardSortType(){return n.ui?.mobile?.awardSortType??"date"}set awardSortType(e){n.ui.mobile.awardSortType=e,n.writeConfiguration(),this.update()}get awardSortTypeReverse(){return n.ui?.mobile?.awardSortTypeReverse??"1"}set awardSortTypeReverse(e){n.ui.mobile.awardSortTypeReverse=e?-1:1,n.writeConfiguration(),this.update()}applySort(){this.awardedGames=this.awardedGames.sort((e,t)=>this.awardSortTypeReverse*_[this.awardSortType](e,t))}applyFilter(){this.awardedGames=I.VisibleUserAwards,this.awardFilterName!=="award"&&(this.awardedGames=this.awardedGames.filter(e=>e.award==this.awardFilterName)),this.platformFilterCode!=="platform"&&(this.awardedGames=this.awardedGames.filter(e=>e.ConsoleID==this.platformFilterCode))}listTypes={list:"list",grid:"grid"};awardTypesNames={beaten:"Beaten",beaten_softcore:"Beaten Softcore",completed:"Completed",mastered:"Mastered",event:"Event",award:"Award Type"};sortMethods={latest:"date",title:"title"};awardedGames=[];constructor(){!n.ui.mobile.awards&&(n.ui.mobile.awards={}),ui.showLoader(),this.downloadAwardsData().then(()=>{this.getAwardsStats(),this.update()})}async update(){ui.showLoader(),await C(50),this.applyFilter(),this.applySort();let e=this.AwardsSection();ui.content.innerHTML="",ui.content.append(e),ui.removeLoader();let t=e.querySelector(".user-info__awards-list");D({list:t,items:this.awardedGames,callback:this.getGameElement})}getAwardsStats(){let e=I.VisibleUserAwards.reduce((t,i)=>(!t.platforms[i.ConsoleID]&&(t.platforms[i.ConsoleID]={count:0}),t.platforms[i.ConsoleID].name=i.ConsoleName,t.platforms[i.ConsoleID].count++,!t.awards[i.award]&&(t.awards[i.award]={count:0}),t.awards[i.award].name=this.awardTypesNames[i.award],t.awards[i.award].count++,t),{platforms:{},awards:{}});this.platformCodes=e.platforms,this.awardTypes=e.awards}async downloadAwardsData(){!I&&(I=await h.getUserAwards({}))}AwardsSection(){let e=document.createElement("section");return e.classList.add("awards__section","section"),e.innerHTML=`
      ${this.headerHtml()}
  ...
  `;let i=()=>{let r=document.createElement("div");return r.classList.add("context__controls"),a.elements.forEach(o=>{switch(o.type){case"radio":r.innerHTML+=`
    ...
    `}update(e=this.gameID){if(d.showLoader(),v[e]){this.gameData=v[this.gameID],this.achievements=Object.values(v[this.gameID].Achievements);let t=this.generateGameSection(this.gameData);d.content.innerHTML="",d.content.append(t),this.updateCheevos(this.gameData),d.removeLoader()}else h.getGameProgress({gameID:e}).then(t=>{v[e]=t}).then(()=>this.update())}updateGameSection(e){e??=this.gameData;let t=r=>{let{ImageIcon:o,Title:c,ConsoleName:l,Developer:m,UserTotalPlaytime:u,TotalPoints:g}=r;document.querySelector(".game-image").src=E(o),document.querySelector(".game-title").innerHTML=c,document.querySelector(".game-meta>.platform").innerHTML=l,document.querySelector(".game-meta>.game-dev").innerHTML=m,document.querySelector(".playtime").innerHTML="Time played: "+ce(u,!1)},i=r=>{let{NumAchievements:o,NumAwardedToUserHardcore:c,points_total:l}=r,m=r.earnedStats?.hard?.points??0,u=Math.floor(100*c/o);document.querySelector(".progress-card").style.setProperty("--unlock-rate",`${u}%`),document.querySelector(".progress-card .progress-count").innerHTML=`${c} / ${o}`,document.querySelector(".progress-footer .points").innerHTML=`${m} / ${l} points`,document.querySelector(".progress-card .progress-footer>span").innerHTML=`${u}% completed`},s=r=>{function o(m,u){let{Title:g,Description:T,Points:f,TrueRatio:y,Type:G,BadgeName:ge,DateEarnedHardcore:Z,DateEarned:ee,NumAwardedHardcore:Le,rateEarnedHardcore:fe}=m,te=Z||ee,ve=Math.round(100*y/f)/100,ae=p(`
                    <div class="list-item achievement ${G||""} ${ee?"unlocked":"locked"} ${Z?"hardcore":""} ">
                        <div class="item-icon">
                            <img class="item-img" src="${F({BadgeName:ge})}"/>
                        </div>
                        <div class="item-meta">
                            <div class="item-name">${g}</div>
                            <div class="item-desc">${T}</div>
                            <div class="item-icons-row">
                                <span class="mask-icon ${G??"none"}"></span> 
                                <span>${f}pts.</span>
                                <span class="badge badge_solid-black">\u2A2F${ve}</span>
                                <span>\u25D4 ${fe}</span>
                                <span>${te?new Date(te).toLocaleString():""}</span>
                            </div>
                        </div>
                        <!--<div class="item-points">${f}</div>-->
                    </div>
                `);return ae.addEventListener("click",_e=>{_e.stopPropagation(),d.showAchivDetails(m.ID,u.ID),console.log(u)}),ae}let c=()=>{document.querySelector("#sort-name").innerHTML=this.sortType,document.querySelector("#filter-name").innerHTML=this.filter},l=document.querySelector(".achievement-list");l.innerHTML="",this.achievements.forEach(m=>{let u=o(m,r);l.append(u)}),c()};t(e),i(e),s(e)}generateGameSection(e){let t=()=>{let o=p(`
            ...
            `);return o.addEventListener("click",c=>{c.stopPropagation(),d.showGameDetails(e.ID)}),o},i=()=>p(`
        ...
        `),s=()=>{let o=p(`
            ...
            `);return o.querySelector("#sort-ach-button").addEventListener("click",c=>{M(this.sortContext(),c)}),o.querySelector("#filter-ach-button").addEventListener("click",c=>{M(this.filterContext(),c)}),o},r=p(`
            <div class="game-content content"></div>
        `);return r.append(t(),i(),s()),r}};var de=["ID","Title","badges","ConsoleID","ImageIcon","NumAchievements","Points","retropoints","relisedAt","timeToBeat","timeToMaster","playersHardcore","timesBeaten","timesMastered","playersTotal","genres","series","updated"];var Se="./json/games/all_min.json",Ce=a=>a.map(t=>{let i={};if(t.forEach((s,r)=>{i={...i,[de[r]]:s}}),i.timeToBeat){let s=Math.round(i.timeToBeat/60),r=s>=60?`${~~(s/60)}hr${s>119?"s":""}`:"",o=s%60>0?`${s%60}mins`:"",c=`${r} ${o}`;i.timeToBeatString=c}return i.Date=i.relisedAt?new Date(i.relisedAt).toLocaleDateString():"",i.ModifiedDate=i.updated?new Date(i.updated).toLocaleDateString():"",i.trueRatio=+(i.retropoints/i.Points).toFixed(1),i.beatenRate=Number((100*i.timesBeaten/i.playersHardcore).toFixed(1))||0,i.masteryRate=Number((100*i.timesMastered/i.playersHardcore).toFixed(1))||0,i.ImageIcon=`/Images/${i.ImageIcon}.png`,i.badges??=[],i}),me=async(a=Se)=>{let t=await(await fetch(a)).json();return Ce(t)};function ue(a){return p(`
        <div class="section__header-container">
    ...
    `)}function U(a){let{ID:e,ImageIcon:t,Title:i,badges:s,NumAchievements:r,Points:o,ConsoleID:c}=a,l=p(`
    ...
    `,e}getGameElement(e){let t={...e,badges:[],Points:e.PointsTotal,NumAchievements:e.AchievementsPublished};return U(t)}};var A,j,Q,De=({userName:a,apiKey:e,userObj:t})=>{n.USER_NAME=a,n.API_KEY=e,n.identConfirmed=!0,n.userImageSrc=`https://media.retroachievements.org${t?.UserPic}`,A.classList.remove("error"),A.classList.add("verified")},Ae=()=>{let a=j?.value??"",e=Q?.value??"";h.verifyUserIdent({userName:a,apiKey:e}).then(t=>{t.ID?(De({userName:a,apiKey:e,userObj:t}),setTimeout(()=>{d.goto.home(),location.reload(!0)},1e3)):(n.identConfirmed=!1,A.classList.add("error"),A.classList.remove("verified"))})},pe=()=>fetch("./sections/login.elem").then(e=>e.text()).then(e=>{let t=document.createElement("section");return t.className="login__section",t.innerHTML=e,A=t.querySelector("#login__submit-button"),j=t.querySelector("#login_user-name"),Q=t.querySelector("#login__api-key"),t}).then(e=>(j.value=n?.USER_NAME??"",Q.value=n?.API_KEY??"",A.classList.toggle("verified",n.identConfirmed),A.addEventListener("click",t=>{Ae()}),e));var he=()=>{let a=document.createElement("div");return a.classList.add("loading_screen"),a.innerHTML='<div class="loading_screen__loader-icon"></div>',a};var V=class{constructor(){this.update()}getSectionElement(){return p(`
        ...
        `)}async update(){d.showLoader();let e=await h.getLastUnlocks({count:20}),t=this.getSectionElement(),i=e.map(s=>Y(s));t.querySelector("ul")?.append(...i),d.content.innerHTML="",d.content.append(t),d.removeLoader()}};var v={},K=class{get favouritesGames(){return n.ui?.mobile?.favouritesGames??{}}get isSoftmode(){return n.ui?.mobile?.isSoftMode??!1}set isSoftmode(e){n.ui.mobile.isSoftMode=e,n.writeConfiguration()}switchGameMode(){this.isSoftmode=!this.isSoftmode,this.home=new L}routes={"/":async()=>{n.identConfirmed?(this.home=new L,this.clearNavbar(),this.navbar.home.classList.add("checked")):this.goto.login()},"/login":async()=>{this.showLoader();let e=await pe();content.innerHTML="",content.append(e),this.clearNavbar(),this.navbar.login.classList.add("checked"),this.removeLoader()},"/home":async()=>{n.identConfirmed?(this.home=new L,this.clearNavbar(),this.navbar.home.classList.add("checked")):this.goto.login()},"/awards":async()=>{n.identConfirmed?(this.awards=new B,this.clearNavbar(),this.navbar.awards.classList.add("checked")):this.goto.login()},"/library":async()=>{n.identConfirmed?(this.library=new q,this.clearNavbar(),this.navbar.library.classList.add("checked")):this.goto.login()},"/favourites":async()=>{n.identConfirmed?(this.favourites=new z,this.clearNavbar(),this.navbar.favourites.classList.add("checked")):this.goto.login()},"/game":async e=>{if(n.identConfirmed){let t=e.gameID?parseInt(e.gameID,10):!1;t&&(this.game=new W(t))}else this.goto.login()},"/unlocks":async e=>{n.identConfirmed?this.unlocks=new V:this.goto.login()},"/test":async()=>{content.innerHTML="",content.append(await Ee())}};goto={home:()=>{history.pushState(null,null,"#/home"),this.updatePage()},awards:()=>{history.pushState(null,null,"#/awards"),this.updatePage()},library:()=>{history.pushState(null,null,"#/library"),this.updatePage()},favourites:()=>{history.pushState(null,null,"#/favourites"),this.updatePage()},game:e=>{history.pushState(null,null,`#/game&gameID=${e}`),this.updatePage()},login:()=>{history.pushState(null,null,"#/login"),this.updatePage()},unlocks:()=>{history.pushState(null,null,"#/unlocks"),this.updatePage()}};constructor(){!n.ui?.mobile&&(n.ui.mobile={},n.writeConfiguration()),this.initializeElements(),this.addEvents()}initializeElements(){!n.ui.mobile&&(n.ui.mobile={}),this.sectionContainer=document.querySelector(".section-container"),this.app=document.getElementById("app"),this.content=document.getElementById("content"),this.navbar={container:document.querySelector(".navbar"),home:document.querySelector("#navbar_home"),awards:document.querySelector("#navbar_awards"),library:document.querySelector("#navbar_library"),favourites:document.querySelector("#navbar_favourites"),login:document.querySelector("#navbar_login")},n.identConfirmed&&this.navbar.login.classList.add("hidden")}addEvents(){window.addEventListener("hashchange",()=>{this.updatePage()}),window.addEventListener("DOMContentLoaded",()=>{window.dispatchEvent(new Event("hashchange"))}),app.addEventListener("click",()=>{this.removeContext(),this.removePopups()}),app.addEventListener("mousedown",()=>{this.removeContext()})}clearNavbar(){this.navbar.container.querySelectorAll(".checked").forEach(e=>e.classList.remove("checked"))}updatePage(){let e=window.location.hash.substring(1),[t,i]=e.split("&"),s=this.routes[t]||this.routes["/"],r=new URLSearchParams(i),o={};for(let[c,l]of r.entries())o[c]=l;s(o)}removePopups(){document.querySelectorAll(".popup").forEach(e=>e.remove())}removeContext(){document.querySelectorAll(".context").forEach(e=>{e.classList.add("hidden"),setTimeout(()=>e.remove(),1e3)})}async showGameDetails(e){this.removePopups(),this.showLoader();let t=document.createElement("div");t.addEventListener("touchend",r=>r.stopPropagation()),t.classList.add("popup-info__container","popup"),v[e]?(t.innerHTML=this.gamePopupHtml(v[e]),this.content.append(t),this.removeLoader()):h.getGameProgress({gameID:e}).then(r=>{v[e]=r,t.innerHTML=this.gamePopupHtml(r),this.content.append(t)}).then(()=>this.removeLoader());let i=v[e],s=this.gamePopupHtml(i);t.innerHTML=s,await C(500),document.querySelectorAll(".popup-info__image").forEach(r=>{r.addEventListener("click",o=>{o.stopPropagation();let c=document.createElement("div");c.classList.add("image-preview-popup"),c.innerHTML=`
          <img src="${r.src}" alt="">
        `,d.content.appendChild(c),c.addEventListener("click",l=>{l.stopPropagation(),c.remove()})})})}gamePopupHtml(e){let t=(i,s)=>`
        <div class="popup-info__property">${i}: <span>${s}</span></div>
    `;return`
      ...
      <a class="round-button icon-button download-icon simple-button game-popup__download-button"
          href="https://google.com/search?q='${e?.FixedTitle}' '${w[e?.ConsoleID]}' ${$e}" target="_blank"></a>
    ...
    <div class="hor-line"></div>
      <div class="popup-info__properties">
          ${t("Platform",e?.ConsoleName)}
          ${t("Developer",e?.Developer)}
          ${t("Genre",e?.Genre)}
          ${t("Publisher",e?.Publisher)}
          ${t("Released",e?.Released)}
          ${t("Achievements",e?.NumAchievements)}
          ${t("Points",e?.points_total)}
          ${t("True Ratio",e?.retroRatio)}
          ${t("Total players",e?.NumDistinctPlayers)}

      </div>
    `}async showAchivDetails(e,t){if(this.removePopups(),this.showLoader(),v[t]){let i=document.createElement("div");i.addEventListener("touchend",o=>o.stopPropagation()),i.classList.add("popup-info__container","popup");let s=v[t].Achievements[e],r=this.achivPopupHtml(s);i.innerHTML=r,this.content.append(i),this.removeLoader()}else{let i=await h.getGameProgress({gameID:t});v[t]=i,this.showAchivDetails(e,t)}}achivPopupHtml(e){let t=(i,...s)=>(s=s.filter(r=>r),s.length?`
          <div class="popup-info__property">${i}: <span>${s.join(" | ")}</span></div>
      `:"");return`
    ...
    <div class="popup-info__properties">
        ...
        ${t("True Ratio",Number(100*e?.TrueRatio/e?.Points)/100)}
        ${t("Total players",e?.totalPlayers)}
        ${t("Total unlocks",e?.NumAwardedHardcore,e?.NumAwarded)}
        ${t("Unlock Rate",e?.rateEarnedHardcore,e?.rateEarned)}
        <!--${t("Difficulty",e?.difficulty)}-->
        ${t("Unlock Date",R(e?.DateEarnedHardcore)||R(e?.DateEarned))}
        ${t("Created",new Date(e?.DateCreated).toLocaleDateString(),e?.DateModified&&new Date(e?.DateModified).toLocaleDateString())}

    </div>
  `}expandGameItem(e,t){let i=t.closest("li");i.classList.toggle("expanded");let s=r=>{this.showLoader();let o=p(`
        <div class="user-info__game-achivs-container">
            <ul class ="user-info__game-achivs-list"/>
        </div>
      `),c=o.querySelector("ul");i.appendChild(o),v[r]?(Object.values(v[r].Achievements).sort((l,m)=>_.date(l,m)).forEach(l=>{c.innerHTML+=this.cheevoBadgeHtml(l,r)}),this.removeLoader()):h.getGameProgress({gameID:r}).then(l=>{v[r]=l,Object.values(l.Achievements).sort((m,u)=>_.date(m,u)).forEach(m=>{c.innerHTML+=this.cheevoBadgeHtml(m,r)})}).then(()=>this.removeLoader())};i.querySelector(".user-info__game-achivs-container")??s(e)}achivHtmlList(e,t){return`    
        ...
        `}showLoader(){this.removeLoader(),this.app.append(he())}removeLoader(){document.querySelectorAll(".loading_screen").forEach(e=>e.remove())}},Ee=()=>fetch("./sections/test.elem").then(e=>e.text()).then(e=>{let t=document.createElement("section");return t.className="test__section section",t.innerHTML=e,t});var $e="site:www.romhacking.net OR site:wowroms.com/en/roms OR site:cdromance.org OR site:coolrom.com.au/roms OR site:planetemu.net OR site:emulatorgames.net OR site:romsfun.com/roms OR site:emu-land.net/en";var n=new N,h=new H,d=new K;window.ui=d;window.generateContextMenu=M;})();
