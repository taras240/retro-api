(()=>{var _={date:(a,e)=>{let t=a.DateEarned?new Date(a.DateEarnedHardcore?a.DateEarnedHardcore:a.DateEarned):-1/0;return(e.DateEarned?new Date(e.DateEarnedHardcore?e.DateEarnedHardcore:e.DateEarned):-1/0)-t},earnedCount:(a,e)=>e.NumAwardedHardcore-a.NumAwardedHardcore,points:(a,e)=>parseInt(a.Points)-parseInt(e.Points),truepoints:(a,e)=>a.TrueRatio-e.TrueRatio,default:(a,e)=>a.DisplayOrder===0?_.id(a,e):a.DisplayOrder-e.DisplayOrder,id:(a,e)=>a.ID-e.ID,disable:(a,e)=>0,achievementsCount:(a,e)=>parseInt(a.NumAchievements)-parseInt(e.NumAchievements),title:(a,e)=>{let t=a.Title?.toUpperCase()??a.FixedTitle.toUpperCase(),i=e.Title?.toUpperCase()??e.FixedTitle.toUpperCase();return t<i?-1:t>i?1:0},award:(a,e)=>{let t={event:6,mastered:5,"beaten-hardcore":4,completed:3,"beaten-softcore":2,started:1},i=t[e.award]??0,s=t[a.award]??0,r=new Date(e.AwardedAt),o=new Date(a.AwardedAt);return i-s!=0?i-s:r-o}};var G=class{get _savedCompletionProgress(){return n._cfg?.apiWorker?.completionProgress??{}}get SAVED_COMPLETION_PROGRESS(){let e=this._savedCompletionProgress;return!e?.Total||n._cfg.apiWorker.targetUser!==n.targetUser?this.updateCompletionProgress({batchSize:500}).then(()=>this._savedCompletionProgress):this.updateCompletionProgress({batchSize:20,savedArray:e.Results}).then(()=>this._savedCompletionProgress)}set SAVED_COMPLETION_PROGRESS(e){e.Results=e.Results.map(t=>(delete t.ConsoleName,delete t.NumLeaderboards,t)),n._cfg.apiWorker||(n._cfg.apiWorker={}),n._cfg.apiWorker.targetUser=n.targetUser,n._cfg.apiWorker.completionProgress=e,n.writeConfiguration()}baseUrl="https://retroachievements.org/API/";endpoints={userProfile:"API_GetUserProfile.php",gameProgress:"API_GetGameInfoAndUserProgress.php",recentAchieves:"API_GetUserRecentAchievements.php",gameInfo:"API_GetGame.php",extendedGameInfo:"API_GetGameExtended.php",recentlyPlayedGames:"API_GetUserRecentlyPlayedGames.php",userAwards:"API_GetUserAwards.php",userGameRankAndScore:"API_GetUserGameRankAndScore.php",completionProgress:"API_GetUserCompletionProgress.php",gameList:"API_GetGameList.php",userSummary:"API_GetUserSummary.php",wantToPlay:"API_GetUserWantToPlayList.php"};async getLastUnlocks({apiKey:e,targetUser:t}){let i=new URL(this.endpoints.recentAchieves,this.baseUrl),s={y:e||n.API_KEY,u:t||n.targetUser,m:1440*31};return i.search=new URLSearchParams(s),(await fetch(i).then(c=>c.json()))?.map(c=>({...c,ID:c.AchievementID,DateEarned:c.Date})).sort((c,l)=>_.date(c,l))??[];return[{ID:383065,GameID:1891,GameTitle:"Puzznic",Title:"Enigma Explorer",Description:"Reach a score of 50,000 in Puzznic",Points:2,Type:null,BadgeName:"432937",IsAwarded:"1",DateAwarded:"2026-06-05 17:13:14",HardcoreAchieved:1},{ID:383073,GameID:1891,GameTitle:"Puzznic",Title:"Puzznic Level 1 - Riddle Ridge",Description:"In a single session, complete all of the Puzznic puzzles on level 1 [No continues]",Points:3,Type:"progression",BadgeName:"432901",IsAwarded:"1",DateAwarded:"2026-06-05 17:11:57",HardcoreAchieved:1}]}getUrl({endpoint:e,targetUser:t,gameID:i,minutes:s,apiKey:r,userName:o,achievesCount:c,count:l,offset:p}){let m=new URL(e,this.baseUrl),f={y:r||n.API_KEY,z:o||n.USER_NAME,u:t||n.targetUser,g:i||n.gameID,m:s||2e3,i:i||n.gameID,f:1,h:1,a:c||5,c:l||20,o:p||0};return m.search=new URLSearchParams(f),m}constructor(){}getUserCompelitionProgress({targetUser:e,count:t,offset:i}){let s=this.getUrl({targetUser:e||n.targetUser,count:t||100,offset:i||0,endpoint:this.endpoints.completionProgress});return fetch(s).then(r=>r.json()).then(r=>(r.Results=r.Results.map(o=>(o.ID=o.GameID,o.NumAchievements=o.MaxPossible,delete o.MaxPossible,delete o.NumLeaderboards,o)),r))}getUserAwards({targetUser:e}){let t=this.getUrl({targetUser:e||n.targetUser,endpoint:this.endpoints.userAwards});return fetch(t).then(i=>i.json()).then(i=>(i.VisibleUserAwards=i.VisibleUserAwards.map(s=>["Mastery/Completion","Game Beaten"].includes(s.AwardType)?(s.award=s.AwardType=="Game Beaten"?s.AwardDataExtra=="1"?"beaten":"beaten_softcore":s.AwardDataExtra=="1"?"mastered":"completed",s.DateEarned=s.AwardedAt,s.ConsoleName=="Events"&&(s.award="event"),s.timeString=this.toLocalTimeString(s.AwardedAt),s=this.fixGameTitle(s),s):null).filter(s=>s),i))}getGameProgress({targetUser:e,gameID:t}){let i=this.getUrl({endpoint:this.endpoints.gameProgress,targetUser:e||n.targetUser,gameID:t||n.gameID});return fetch(i).then(s=>s.json()).then(s=>{s={...s,TotalRealPlayers:0,TotalRetropoints:0,points_total:0,progressionRetroRatio:0,beatenCount:1/0,masteredCount:1/0,earnedStats:{soft:{count:0,points:0,retropoints:0},hard:{count:0,points:0,retropoints:0}}};let r={Count:0,WinCount:0,WinAwardedCount:0,WinEarnedCount:0},o={isBeaten:!0,isBeatenSoftcore:!0,isWinEarned:!1,isWinEarnedSoftcore:!1};for(let l of Object.values(s.Achievements))s.TotalRetropoints+=l.TrueRatio,s.points_total+=l.Points,s.TotalRealPlayers<l.NumAwarded&&(s.TotalRealPlayers=l.NumAwarded),l.DateEarned&&(s.earnedStats.soft.count+=1,s.earnedStats.soft.points+=l.Points,s.earnedStats.soft.retropoints+=l.TrueRatio),l.DateEarnedHardcore&&(s.earnedStats.hard.count+=1,s.earnedStats.hard.points+=l.Points,s.earnedStats.hard.retropoints+=l.TrueRatio),l.type==="progression"&&(r.Count++,l.DateEarned?l.DateEarnedHardcore||(o.isBeaten=!1):(o.isBeaten=!1,o.isBeatenSoftcore=!1),s.beatenCount>l.NumAwardedHardcore&&(s.beatenCount=l.NumAwardedHardcore)),l.type==="win_condition"&&(l.DateEarnedHardcore?(o.isWinEarned=!0,o.isWinEarnedSoftcore=!0):l.DateEarned&&(o.isWinEarnedSoftcore=!0),r.WinCount++,l.NumAwardedHardcore>r.WinAwardedCount&&(r.WinAwardedCount=l.NumAwardedHardcore),l.DateEarnedHardcore&&r.WinEarnedCount++),l.NumAwardedHardcore<s.masteredCount&&(s.masteredCount=l.NumAwardedHardcore);s.achievements_published==s.NumAwardedToUserHardcore?s.award="mastered":o.isBeaten&&(o.isWinEarned||r.WinCount==0)&&(s.award="beaten"),s={...s,winVariantCount:r.WinCount,winEarnedCount:r.WinEarnedCount,progressionSteps:r.WinCount>0?r.Count+1:r.Count},r.WinCount>0&&(s.beatenCount=r.WinAwardedCount),s.beatenCount!=1/0&&(s.beatenRate=~~(1e4*s.beatenCount/s.TotalRealPlayers)/100),s.masteredCount!=1/0&&(s.masteryRate=~~(1e4*s.masteredCount/s.TotalRealPlayers)/100);let c=~~(s.TotalRetropoints/s.points_total*100)/100;return s.retroRatio=c,s.gameDifficulty=c>9?"insane":c>7?"expert":c>5?"pro":c>3?"standard":"easy",Object.values(s.Achievements).map(l=>this.fixAchievement(l,s)),s=this.fixGameTitle(s),s})}getGameInfo({gameID:e,extended:t}){let i=this.getUrl({endpoint:this.endpoints[t?"extendedGameInfo":"gameInfo"],gameID:e});return fetch(i).then(s=>s.json())}getUserProfile({userName:e}){let t=this.getUrl({targetUser:e,userName:e,endpoint:this.endpoints.userProfile});return fetch(t).then(i=>i.json())}getUserSummary({targetUser:e,gamesCount:t=3,achievesCount:i}){let s=this.getUrl({targetUser:e,gameID:t,achievesCount:i,endpoint:this.endpoints.userSummary});return fetch(s).then(r=>r.json()).then(r=>(r.RecentlyPlayed=r.RecentlyPlayed.map(o=>(o.LastPlayed=this.toLocalTimeString(o.LastPlayed),r.Awarded[o.GameID]&&(o={...o,...r.Awarded[o.GameID]}),o=this.fixGameTitle(o),o)),r.RecentAchievements=Object.values(r.RecentAchievements).flatMap(o=>Object.values(o)).map(o=>(o.DateEarned=this.toLocalTimeString(o.DateAwarded),o)),r.isInGame=new Date-new Date(r.RecentlyPlayed[0].LastPlayed)<300*1e3,r))}verifyUserIdent({userName:e,apiKey:t}){let i=this.getUrl({targetUser:e,userName:e,apiKey:t,endpoint:this.endpoints.userProfile});return fetch(i).then(s=>s.json())}getGameList({userName:e,apiKey:t,systemID:i}){let s=this.getUrl({userName:e,apiKey:t,gameID:i,endpoint:this.endpoints.gameList});return fetch(s).then(r=>r.json())}doTestEndpoint({endpoint:e}){let t=this.getUrl({endpoint:e});return fetch(t).then(i=>i.json()).then(i=>console.log(i))}async updateCompletionProgress({savedArray:e=[],completionProgress:t=[],batchSize:i=500}){let s=await this.getUserCompelitionProgress({count:i,offset:t.length});t=[...t,...s.Results];let r=t.at(-1);if(e.findIndex(c=>c.hasOwnProperty("GameID")&&c.GameID===r.GameID&&c.MostRecentAwardedDate===r.MostRecentAwardedDate)>=0||t.length===s.Total){let c=t.map(l=>l.GameID);e=e.filter(l=>!c.includes(l.GameID)),e=[...t,...e],this.SAVED_COMPLETION_PROGRESS={Total:e.length,Results:e}}else setTimeout(()=>this.updateCompletionProgress({savedArray:e,completionProgress:t,batchSize:i}),100)}fixAchievement(e,t){let{BadgeName:i,DateEarned:s,DateEarnedHardcore:r,NumAwardedHardcore:o,NumAwarded:c,TrueRatio:l,ID:p}=e,{NumDistinctPlayers:m,NumAwardedToUserHardcore:f,TotalRealPlayers:C}=t,h=100*(o-f*.5)/((m+C)*.5-f*.5);t.Achievements[p]={...e,totalPlayers:m,isEarned:!!s,isHardcoreEarned:!!r,DateEarned:s&&this.toLocalTimeString(s),DateEarnedHardcore:r&&this.toLocalTimeString(r),prevSrc:`https://media.retroachievements.org/Badge/${i}.png`,rateEarned:~~(100*c/m)+"%",rateEarnedHardcore:~~(100*o/m)+"%",trend:h,difficulty:h<1.5&&l>300||l>=500?"hell":h<=3&&l>100||l>=300?"insane":h<8&&l>24?"expert":h<13&&l>10?"pro":h<20&&l>5||l>10?"standard":"easy"}}fixGameTitle(e){let t=[/\[SUBSET[^\[]*\]/gi,/~[^~]*~/g,".HACK//"],i=e.Title,s=t.reduce((r,o)=>{let c=new RegExp(o,"gi"),l=e.Title?.match(c);return l&&l.forEach(p=>{i=i.replace(p,"");let m=p;r.push(m.replace(/[~\.\[\]]|subset -|\/\//gi,""))}),r},[]);return e.badges=s,e.FixedTitle=i?.trim(),e}toLocalTimeString(e){!/(\+00\:00$)|(z$)/gi.test(e)&&(e+="+00:00");let i=new Date(e),s={day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!1};return i}async getWantToPlayGamesList({apiKey:e,targetUser:t,count:i,offset:s}){let r=new URL(this.endpoints.wantToPlay,this.baseUrl),o={y:e||n.API_KEY,u:t||n.targetUser,o:s||0};return r.search=new URLSearchParams(o),(await fetch(r).then(l=>l.json())).Results||[]}};var V="retroApiConfig",U=class{get version(){return this._cfg.version??"0"}set version(e){this._cfg.version=e,this.writeConfiguration()}get API_KEY(){return this._cfg.identification.RAApi_key}set API_KEY(e){this._cfg.identification.RAApi_key=e,this.writeConfiguration()}get USER_NAME(){return this._cfg.identification.RAApi_login}set USER_NAME(e){this._cfg.identification.RAApi_login=e,this.writeConfiguration()}get identConfirmed(){return this._cfg.identification.identConfirmed??!1}set identConfirmed(e){this._cfg.identification.identConfirmed=e,this.writeConfiguration()}get userImageSrc(){return this._cfg.identification.userImageSrc||""}set userImageSrc(e){this._cfg.identification.userImageSrc=e,this.ui.buttons&&(ui.buttons.userImage.src=e),this.writeConfiguration()}get targetUser(){return this._cfg.settings.targetUser||this.USER_NAME}set targetUser(e){this._cfg.settings.targetUser=e,this.writeConfiguration(),this.identConfirmed&&(ui.settings.getLastGameID(),ui.awards.updateAwards())}get gameID(){return this._cfg.settings.gameID}set gameID(e){this._cfg.settings.gameID=e,this.writeConfiguration()}get ui(){return this._cfg.ui}constructor(){this.readConfiguration()}readConfiguration(){let e=JSON.parse(localStorage.getItem(V));e||(e={identification:{RAApi_key:"",RAApi_login:""},settings:{updateDelay:15,sort:"default",gameID:1},ui:{}}),this._cfg=e,localStorage.setItem(V,JSON.stringify(this._cfg)),this.writeConfiguration()}delayedWrite;writeConfiguration(){clearTimeout(this.delayedWrite),this.delayedWrite=setTimeout(()=>{localStorage.setItem(V,JSON.stringify(this._cfg))},1e3)}};function T(a){return a?.reduce((e,t)=>e+=`<i class="game-badge game-badge__${t.toLowerCase()}">${t}</i>`,"")}function $(a){return new Date(a).toLocaleString()}var u=a=>{/\/>/g.test(a)&&(a=a.replace(/<(\w+)([^>]*)\/>/g,(t,i,s)=>new Set(["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"]).has(i.toLowerCase())?t:`<${i}${s}></${i}>`));let e=document.createElement("template");return e.innerHTML=a.trim(),e.content.firstElementChild};function Y(a){let e=+(a.retropoints/a.hardpoints).toFixed(2);return`
    ...
    `}var N=({BadgeName:a})=>`https://media.retroachievements.org/Badge/${a}.png`,D=a=>`https://media.retroachievements.org${a}`;function K(a,e){let{Title:t,Description:i,ID:s,GameID:r,HardcoreAchieved:o,IsAwarded:c,DateEarned:l,BadgeName:p,Points:m,DateEarnedHardcore:f}=a;e??={ID:r};let h=u(`
                    <div class="list-item achievement ${o||l?"unlocked":"locked"}">
                        <div class="ach-icon">
                            <img class="ach-img" src="${N({BadgeName:p})}"/>
                        </div>
                        <div class="item-meta">
                            <div class="ach-name">${t}</div>
                            <div class="ach-desc">${i}</div>
                            <div class="game-stats__text cheevo-stats__unlocked">${ne(l)}</div>

                        </div>
                        <div class="ach-points">${m}</div>
                    </div>
                `);return h.addEventListener("click",y=>{y.stopPropagation(),d.showAchivDetails(a.ID,e?.ID),console.log(a)}),h}function X({lastAchievements:a}){return a.map(e=>K(e))}var ne=a=>{let e=new Date(a);return e.toLocaleString()};function le(a){let{GameID:e,ImageIcon:t,FixedTitle:i,badges:s,LastPlayed:r,ConsoleName:o,NumAchieved:c,NumAchievedHardcore:l,NumPossibleAchievements:p,ScoreAchieved:m,ScoreAchievedHardcore:f,PossibleScore:C}=a,h=u(`    
        <li class="list-game-item" data-id="${e}">
            <div class="list-item">
                <div class="user-info__game-preview-container">
                    <img class="user-info__game-preview" src="${D(t)}">
                </div>
                <div class="item-meta" >
                    <h2 class="user-info__game-title">${i} ${T(s)}</h2>
    ...
    `);return h.addEventListener("click",y=>{y.stopPropagation(),d.showGameDetails(e)}),h.querySelector(".user-info__game-preview-container")?.addEventListener("click",y=>{y.stopPropagation(),d.goto.game(e)}),h.querySelector(".game-stats__button")?.addEventListener("click",y=>{y.stopPropagation(),d.expandGameItem(e,y.target)}),h}function Q({lastGames:a}){return a.map(e=>le(e))}var I,E=class{constructor(){this.update()}async update(){if(d.showLoader(),I){let e=this.HomeSection();d.content.innerHTML="",d.content.append(e),d.removeLoader()}else await this.loadUserInfo(),this.update()}async loadUserInfo(){let e=await v.getUserSummary({gamesCount:5,achievesCount:8});I={userName:e.User,status:e.Status?.toLowerCase(),richPresence:e.RichPresenceMsg,memberSince:e.MemberSince,userImageSrc:`https://media.retroachievements.org${e.UserPic}`,userRank:e.Rank?`Rank: ${e.Rank} (Top ${~~(1e4*e.Rank/e.TotalRanked)/100}%)`:"Rank is unavailable",softpoints:e.TotalSoftcorePoints,retropoints:e.TotalTruePoints,hardpoints:e.TotalPoints,lastGames:e.RecentlyPlayed,lastAchievements:Object.values(e.RecentAchievements).map(t=>(t.DateEarnedHardcore=t.DateAwarded,t)).sort((t,i)=>_.date(t,i)),isInGame:e.isInGame}}HomeSection(){let e=u(`
        ...
        `);return e.querySelector(".recent-cheevos-list").append(...X(I)),e.querySelector(".recent-games-list").append(...Q(I)),e.querySelector("#see-more-cheevos")?.addEventListener("click",s=>{d.goto.unlocks()}),e}};var S=a=>new Promise(e=>setTimeout(e,a));function A({list:a,items:e,callback:t}){let i=document.createElement("div");i.classList.add("lazy-load_trigger"),a.appendChild(i);let s=0,r=40,o=m=>{for(let f=0;f<m&&s<e.length;f++)a.appendChild(t(e[s++]))};o(r);let c=(m,f)=>{m.forEach(C=>{C.isIntersecting&&(o(r),f.unobserve(i),s<e.length?(a.appendChild(i),f.observe(i)):i.remove())})},l={root:null,rootMargin:"0px",threshold:1};new IntersectionObserver(c,l).observe(i)}var w={1:"Genesis/Mega Drive",2:"Nintendo 64",3:"SNES/Super Famicom",4:"Game Boy",5:"Game Boy Advance",6:"Game Boy Color",7:"NES/Famicom",8:"PC Engine/TurboGrafx-16",9:"Sega CD",10:"32X",11:"Master System",12:"PlayStation",13:"Atari Lynx",14:"Neo Geo Pocket",15:"Game Gear",17:"Atari Jaguar",18:"Nintendo DS",19:"Nintendo Wii",21:"PlayStation 2",23:"Magnavox Odyssey 2",24:"Pokemon Mini",25:"Atari 2600",27:"Arcade",28:"Virtual Boy",29:"MSX",33:"SG-1000",37:"Amstrad CPC",38:"Apple II",39:"Saturn",40:"Dreamcast",41:"PlayStation Portable",43:"3DO Interactive Multiplayer",44:"ColecoVision",45:"Intellivision",46:"Vectrex",47:"PC-8000/8800",49:"PC-FX",51:"Atari 7800",53:"WonderSwan",56:"Neo Geo CD",57:"Fairchild Channel F",63:"Watara Supervision",69:"Mega Duck",71:"Arduboy",72:"WASM-4",73:"Arcadia 2001",74:"Interton VC 4000",75:"Elektor TV Games Computer",76:"PC Engine CD/TurboGrafx-CD",77:"Atari Jaguar CD",78:"Nintendo DSi",80:"Uzebox",101:"Events",102:"Standalone"};var L,H=class{awardTypeContext=()=>({label:"Filter by type",elements:[{label:`All (${L.VisibleUserAwards.length})`,id:"filter_all",type:"radio",onChange:"ui.awards.awardFilter = 'award'",checked:this.awardFilterName==="award",name:"filter-by-award"},...Object.getOwnPropertyNames(this.awardTypes).reduce((e,t)=>{let i={label:`${this.awardTypes[t].name} (${this.awardTypes[t].count})`,id:`filter_code-${t}`,type:"radio",onChange:`ui.awards.awardFilter = '${t}'`,checked:this.awardFilterName==t,name:"filter-by-award"};return e.push(i),e},[])]});awardPlatformContext=()=>({label:"Filter by platform",elements:[{label:`All (${L.VisibleUserAwards.length})`,id:"filter_all",type:"radio",onChange:"ui.awards.platformFilterCode = 'platform'",checked:this.platformFilterName==="platform",name:"filter-by-platform"},...Object.getOwnPropertyNames(this.platformCodes).reduce((e,t)=>{let i={label:`${this.platformCodes[t].name} (${this.platformCodes[t].count})`,id:`filter_code-${t}`,type:"radio",onChange:`ui.awards.platformFilterCode = ${t}`,checked:this.platformFilterCode==t,name:"filter-by-platform"};return e.push(i),e},[])]});awardSortContext=()=>({label:"Sort by",elements:[{label:"Date earned",id:"sort_date-earned",type:"radio",onChange:"ui.awards.awardSortType = 'date'",checked:this.awardSortType==="date",name:"sort-awards"},{label:"Type",id:"sort_award-type",type:"radio",onChange:"ui.awards.awardSortType = 'award'",checked:this.awardSortType==="award",name:"sort-awards"},{label:"Title",id:"sort_title",type:"radio",onChange:"ui.awards.awardSortType = 'title'",checked:this.awardSortType==="title",name:"sort-awards"},{label:"Reverse sort",id:"sort_reverse-sort",type:"checkbox",onChange:"ui.awards.awardSortTypeReverse = this.checked",checked:this.awardSortTypeReverse==-1,name:"sort-awards-reverse"}]});awardListContext=()=>({label:"Show by",elements:[...Object.getOwnPropertyNames(this.listTypes).reduce((e,t)=>{let i={label:`${this.listTypes[t]}`,id:`awards_list-type-${t}`,type:"radio",onChange:`ui.awards.listType = '${t}'`,checked:this.listType==t,name:"awards-list-type"};return e.push(i),e},[])]});get listType(){return n.ui?.mobile?.listType??"list"}set listType(e){n.ui.mobile.listType=e,n.writeConfiguration(),this.update()}get awardFilter(){let e=n.ui?.mobile?.awardsTypeFilter??"award";return this.awardTypesNames[e]}get awardFilterName(){return n.ui?.mobile?.awardsTypeFilter??"award"}set awardFilter(e){n.ui.mobile.awardsTypeFilter=e,n.writeConfiguration(),this.update()}get platformFilterName(){let e=n.ui?.mobile?.platformFilter??"platform";return e=="platform"?"platform":w[e]}get platformFilterCode(){return n.ui?.mobile?.platformFilter??"platform"}set platformFilterCode(e){n.ui.mobile.platformFilter=e,n.writeConfiguration(),this.update()}get awardSortType(){return n.ui?.mobile?.awardSortType??"date"}set awardSortType(e){n.ui.mobile.awardSortType=e,n.writeConfiguration(),this.update()}get awardSortTypeReverse(){return n.ui?.mobile?.awardSortTypeReverse??"1"}set awardSortTypeReverse(e){n.ui.mobile.awardSortTypeReverse=e?-1:1,n.writeConfiguration(),this.update()}applySort(){this.awardedGames=this.awardedGames.sort((e,t)=>this.awardSortTypeReverse*_[this.awardSortType](e,t))}applyFilter(){this.awardedGames=L.VisibleUserAwards,this.awardFilterName!=="award"&&(this.awardedGames=this.awardedGames.filter(e=>e.award==this.awardFilterName)),this.platformFilterCode!=="platform"&&(this.awardedGames=this.awardedGames.filter(e=>e.ConsoleID==this.platformFilterCode))}listTypes={list:"list",grid:"grid"};awardTypesNames={beaten:"Beaten",beaten_softcore:"Beaten Softcore",completed:"Completed",mastered:"Mastered",event:"Event",award:"Award Type"};sortMethods={latest:"date",title:"title"};awardedGames=[];constructor(){!n.ui.mobile.awards&&(n.ui.mobile.awards={}),ui.showLoader(),this.downloadAwardsData().then(()=>{this.getAwardsStats(),this.update()})}async update(){ui.showLoader(),await S(50),this.applyFilter(),this.applySort();let e=this.AwardsSection();ui.content.innerHTML="",ui.content.append(e),ui.removeLoader();let t=e.querySelector(".user-info__awards-list");A({list:t,items:this.awardedGames,callback:this.getGameElement})}getAwardsStats(){let e=L.VisibleUserAwards.reduce((t,i)=>(!t.platforms[i.ConsoleID]&&(t.platforms[i.ConsoleID]={count:0}),t.platforms[i.ConsoleID].name=i.ConsoleName,t.platforms[i.ConsoleID].count++,!t.awards[i.award]&&(t.awards[i.award]={count:0}),t.awards[i.award].name=this.awardTypesNames[i.award],t.awards[i.award].count++,t),{platforms:{},awards:{}});this.platformCodes=e.platforms,this.awardTypes=e.awards}async downloadAwardsData(){!L&&(L=await v.getUserAwards({}))}AwardsSection(){let e=document.createElement("section");return e.classList.add("awards__section","section"),e.innerHTML=`
      ${this.headerHtml()}
  ...
  `,t}};var R=Object.freeze({PROGRESSION:"progression",MISSABLE:"missable",WIN:"win_condition"});var x={earned:({DateEarnedHardcore:a})=>a,earnedSoftcore:({DateEarned:a,DateEarnedHardcore:e})=>!e&&a,notEarned:({DateEarnedHardcore:a,DateEarned:e})=>!a&&!e,missable:({Type:a})=>a===R.MISSABLE,progression:({Type:a})=>a===R.PROGRESSION||a===R.WIN,typeless:a=>!x.progression(a)&&!x.missable(a),all:()=>!0,genre:({genres:a,genre:e})=>a?.includes(e),level:({level:a},{targetLevel:e})=>parseInt(a)===parseInt(e),group:({group:a,targetGroup:e})=>a===e,leveless:({level:a})=>!a,setID:({setID:a},{targetSet:e})=>a==e,disabled:()=>!0},j=Object.freeze({UNLOCKED:"earned",UNLOCKED_SOFT:"earnedSoftcore",MISSABLE:"missable",PROGRESSION:"progression"});function ce(a){return new Date(a)}var k=Object.freeze({TIME_TO_UNLOCK:"timeToUnlock",UNLOCK_DATE:"latest",TRUE_RATIO:"trueRatio",UNLOCK_RATE:"unlockRate",POINTS:"points",TRUE_POINTS:"truepoints",UNLOCK_DATE_RA:"raLatest",DEFAULT:"default",LEVEL:"level",CUSTOM_ORDER:"customOrder"}),b={latestHardcore:(a,e,t=1,i=!1)=>b.latest(a,e,t,i,!0),latest:(a,e,t=1,i=!1,s=!1)=>{let r=F(a),o=F(e);if(i){let c=!r,l=!o;if(c&&!l)return 1;if(!c&&l)return-1}return(o-r)*t},raLatest:(a,e,t=1,i)=>{let s=F(a),r=F(e);return s*r===0&&s-r!==0?r?t:-1*t:b.default(a,e)},earnedCount:(a,e,t=1)=>(e.NumAwardedHardcore-a.NumAwardedHardcore)*t,unlockRate:(a,e,t=1)=>b.earnedCount(a,e,t),rarest:(a,e,t=1)=>b.earnedCount(a,e,t),points:(a,e,t=1)=>(a.Points-e.Points)*t,truepoints:(a,e,t=1)=>(a.TrueRatio-e.TrueRatio)*t,trueRatio:(a,e,t=1)=>{let i=a.TrueRatio/a.Points,s=e.TrueRatio/e.Points;return(i-s)*t},default:(a,e,t=1)=>a.DisplayOrder!=0?(a.DisplayOrder-e.DisplayOrder)*t:b.id(a,e,t),customOrder:(a,e)=>a.customOrder-e.customOrder,progression:(a,e)=>{if(a.DisplayOrder===e.DisplayOrder)return b.unlockRate(a,e);let t=({DisplayOrder:r,Type:o})=>o===R.PROGRESSION?r:r*1e3,i=t(a),s=t(e);return i-s},id:(a,e,t=1)=>(a.ID-e.ID)*t,disable:(a,e)=>0,level:(a,e,t,i=!1)=>i&&(!a.level||!e.level)&&!(!a.level&&!e.level)?e.level?1:-1:!a.level&&!e.level?i?0:b.default(a,e,t):a.level?e.level?(a.level-e.level)*t:-1*t:1*t,timeToUnlock:(a,e,t,i=!1)=>i&&(!a.timeToUnlock||!e.timeToUnlock)&&!(!a.timeToUnlock&&!e.timeToUnlock)?e.timeToUnlock?1:-1:!a.timeToUnlock&&!e.timeToUnlock?i?0:b.difficulty(a,e,t):a.timeToUnlock?e.timeToUnlock?(a.timeToUnlock-e.timeToUnlock)*t:-1*t:1*t,difficulty:(a,e,t)=>{let i=a.difficulty-e.difficulty;return i==0&&(i=e.NumAwardedHardcore-a.NumAwardedHardcore),i*t}},F=(a,e=!1)=>{let t=a.DateEarnedHardcore||!e&&a.DateEarned;return t?ce(t):0};function Z(a,e=!1){if(!a)return"-";if(a=Number(a),e)return a>=3600?`${Math.round(a/3600)}h`:a>=60?`${Math.round(a/60)}min`:`${Math.round(a)}s`;let t=Math.floor(a/3600),i=Math.floor(a%3600/60),s=Math.floor(a%60);return t?`${t}h ${i}m`:i?`${i} min${i>1?"s":""}`:`${s} secs`}function P(a,e){e.stopPropagation(),ui.removeContext();let t=document.createElement("div");t.classList.add("context-menu__container","context"),t.addEventListener("touchend",r=>r.stopPropagation()),t.addEventListener("mousedown",r=>r.stopPropagation()),t.innerHTML+=`
  ...
  `;let i=()=>{let r=document.createElement("div");return r.classList.add("context__controls"),a.elements.forEach(o=>{switch(o.type){case"radio":r.innerHTML+=`
            ...
            <div class="game-header__main-info">
                ...
                <div class="game-header__description-container">
                    <h1 class="game-header__title">
                     ${this.gameData.FixedTitle} ${T(this.gameData.badges)}                       
                    </h1>
    ...
    `}update(e=this.gameID){if(d.showLoader(),g[e]){this.gameData=g[this.gameID],this.achievements=Object.values(g[this.gameID].Achievements);let t=this.generateGameSection(this.gameData);d.content.innerHTML="",d.content.append(t),this.updateCheevos(this.gameData),d.removeLoader()}else v.getGameProgress({gameID:e}).then(t=>{g[e]=t}).then(()=>this.update())}updateGameSection(e){e??=this.gameData;let t=r=>{let{ImageIcon:o,Title:c,ConsoleName:l,Developer:p,UserTotalPlaytime:m,TotalPoints:f}=r;document.querySelector(".game-image").src=D(o),document.querySelector(".game-title").innerHTML=c,document.querySelector(".game-meta>.platform").innerHTML=l,document.querySelector(".game-meta>.game-dev").innerHTML=p,document.querySelector(".playtime").innerHTML="Time played: "+Z(m,!1)},i=r=>{let{NumAchievements:o,NumAwardedToUserHardcore:c,points_total:l}=r,p=r.earnedStats?.hard?.points??0,m=Math.floor(100*c/o);document.querySelector(".progress-card").style.setProperty("--unlock-rate",`${m}%`),document.querySelector(".progress-card .progress-count").innerHTML=`${c} / ${o}`,document.querySelector(".progress-footer .points").innerHTML=`${p} / ${l} points`,document.querySelector(".progress-card .progress-footer>span").innerHTML=`${m}% completed`},s=r=>{function o(p,m){let{Title:f,Description:C,Points:h,BadgeName:y,DateEarnedHardcore:re}=p,J=u(`
                    <div class="list-item achievement ${re?"unlocked":"locked"}">
                        <div class="item-icon">
                            <img class="item-img" src="${N({BadgeName:y})}"/>
                        </div>
                        <div class="item-meta">
                            <div class="item-name">${f}</div>
                            <div class="item-desc">${C}</div>
                        </div>
                        <div class="item-points">${h}</div>
                    </div>
                `);return J.addEventListener("click",oe=>{oe.stopPropagation(),d.showAchivDetails(p.ID,m.ID),console.log(m)}),J}let c=()=>{document.querySelector("#sort-name").innerHTML=this.sortType,document.querySelector("#filter-name").innerHTML=this.filter},l=document.querySelector(".achievement-list");l.innerHTML="",this.achievements.forEach(p=>{let m=o(p,r);l.append(m)}),c()};t(e),i(e),s(e)}generateGameSection(e){let t=()=>{let o=u(`
            ...
            `);return o.addEventListener("click",c=>{c.stopPropagation(),d.showGameDetails(e.ID)}),o},i=()=>u(`
        ...
        `),s=()=>{let o=u(`
            ...
            `);return o.querySelector("#sort-ach-button").addEventListener("click",c=>{P(this.sortContext(),c)}),o.querySelector("#filter-ach-button").addEventListener("click",c=>{P(this.filterContext(),c)}),o},r=u(`
            <div class="game-content content"></div>
        `);return r.append(t(),i(),s()),r}};var ee=["ID","Title","badges","ConsoleID","ImageIcon","NumAchievements","Points","retropoints","relisedAt","timeToBeat","timeToMaster","playersHardcore","timesBeaten","timesMastered","playersTotal","genres","series","updated"];var de="./json/games/all_min.json",me=a=>a.map(t=>{let i={};if(t.forEach((s,r)=>{i={...i,[ee[r]]:s}}),i.timeToBeat){let s=Math.round(i.timeToBeat/60),r=s>=60?`${~~(s/60)}hr${s>119?"s":""}`:"",o=s%60>0?`${s%60}mins`:"",c=`${r} ${o}`;i.timeToBeatString=c}return i.Date=i.relisedAt?new Date(i.relisedAt).toLocaleDateString():"",i.ModifiedDate=i.updated?new Date(i.updated).toLocaleDateString():"",i.trueRatio=+(i.retropoints/i.Points).toFixed(1),i.beatenRate=Number((100*i.timesBeaten/i.playersHardcore).toFixed(1))||0,i.masteryRate=Number((100*i.timesMastered/i.playersHardcore).toFixed(1))||0,i.ImageIcon=`/Images/${i.ImageIcon}.png`,i.badges??=[],i}),te=async(a=de)=>{let t=await(await fetch(a)).json();return me(t)};function ae(a){return u(`
        <div class="section__header-container">
    ...
    `)}function M(a){let{ID:e,ImageIcon:t,Title:i,badges:s,NumAchievements:r,Points:o,ConsoleID:c}=a,l=u(`
        <li class="list-game-item">
            <div class="library__game-container list-item"  onclick="ui.showGameDetails(${e}); event.stopPropagation()">
                <div class="awards__game-preview-container" onclick="ui.goto.game(${e}); event.stopPropagation()">
                    <img class="awards__game-preview" src="${D(t)}">
                </div>
                <div class="awards__game-description">
                    <h2 class="library__game-title">${i} ${T(s)}</h2>
    ...
    `,e}getGameElement(e){let t={...e,badges:[],Points:e.PointsTotal,NumAchievements:e.AchievementsPublished};return M(t)}};var ie=()=>fetch("./sections/login.elem").then(e=>e.text()).then(e=>{let t=document.createElement("section");return t.className="login__section",t.innerHTML=e,t}).then(e=>(n.USER_NAME&&(e.querySelector("#login_user-name").value=n.USER_NAME),n.API_KEY&&(e.querySelector("#login__api-key").value=n.API_KEY),n.identConfirmed&&e.querySelector("#login__submit-button").classList.add("verified"),e));var se=()=>{let a=document.createElement("div");return a.classList.add("loading_screen"),a.innerHTML='<div class="loading_screen__loader-icon"></div>',a};var W=class{constructor(){this.update()}getSectionElement(){return u(`
      ...
      <a class="round-button icon-button download-icon simple-button game-popup__download-button"
          href="https://google.com/search?q='${e?.FixedTitle}' '${w[e?.ConsoleID]}' ${ue}" target="_blank"></a>
    ...
    `}async showAchivDetails(e,t){if(this.removePopups(),this.showLoader(),g[t]){let i=document.createElement("div");i.addEventListener("touchend",o=>o.stopPropagation()),i.classList.add("popup-info__container","popup");let s=g[t].Achievements[e],r=this.achivPopupHtml(s);i.innerHTML=r,this.content.append(i),this.removeLoader()}else{let i=await v.getGameProgress({gameID:t});g[t]=i,this.showAchivDetails(e,t)}}achivPopupHtml(e){return`
    ...
    <div class="popup-info__properties">
        ...
        ${e?.isEarned?`<div class="popup-info__property">Date earned : <span>${$(e?.DateEarned)}</span></div>`:""}
        ${e?.isHardcoreEarned?`<div class="popup-info__property">Date earned hardcore: <span>${$(e?.DateEarnedHardcore)}</span></div>`:""}
  ...
  `}expandGameItem(e,t){let i=t.closest("li");i.classList.toggle("expanded");let s=r=>{this.showLoader();let o=u(`
      ...
      `),c=o.querySelector("ul");i.appendChild(o),g[r]?(Object.values(g[r].Achievements).sort((l,p)=>_.date(l,p)).forEach(l=>{c.innerHTML+=this.cheevoBadgeHtml(l,r)}),this.removeLoader()):v.getGameProgress({gameID:r}).then(l=>{g[r]=l,Object.values(l.Achievements).sort((p,m)=>_.date(p,m)).forEach(p=>{c.innerHTML+=this.cheevoBadgeHtml(p,r)})}).then(()=>this.removeLoader())};i.querySelector(".user-info__game-achivs-container")??s(e)}achivHtmlList(e,t){return`    
        ...
        `}showLoader(){this.removeLoader(),this.app.append(se())}removeLoader(){document.querySelectorAll(".loading_screen").forEach(e=>e.remove())}},pe=()=>fetch("./sections/test.elem").then(e=>e.text()).then(e=>{let t=document.createElement("section");return t.className="test__section section",t.innerHTML=e,t});var ue="site:www.romhacking.net OR site:wowroms.com/en/roms OR site:cdromance.org OR site:coolrom.com.au/roms OR site:planetemu.net OR site:emulatorgames.net OR site:romsfun.com/roms OR site:emu-land.net/en";var n=new U,v=new G,d=new z;window.ui=d;window.generateContextMenu=P;window.submitRAData=()=>{let a=d.content.querySelector("#login_user-name").value,e=d.content.querySelector("#login__api-key").value;v.verifyUserIdent({userName:a,apiKey:e}).then(t=>{if(t.ID)he({userName:a,apiKey:e,userObj:t}),setTimeout(()=>{d.goto.home(),location.reload(!0)},1e3);else{n.identConfirmed=!1;let i=d.content.querySelector("#login__submit-button");i.classList.add("error"),i.classList.remove("verified")}})};function he({userName:a,apiKey:e,userObj:t}){n.USER_NAME=a,n.API_KEY=e,n.identConfirmed=!0,n.userImageSrc=`https://media.retroachievements.org${t?.UserPic}`;let i=d.content.querySelector("#login__submit-button");i.classList.remove("error"),i.classList.add("verified")}})();
