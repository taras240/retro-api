...
export class Home {
    ...
    HomeSection() {
        ...
        `);
        const cheevosList = homeSection.querySelector(".recent-cheevos-list");
        cheevosList.append(...recentCheevosElements(USER_INFO));
        const gamesList = homeSection.querySelector(".recent-games-list");
        gamesList.append(...recentGamesElements(USER_INFO));
